...
bool CodegenCVisitor::is_constant_variable(const std::string& name) const {
    ...
    if (symbol != nullptr) {
        ...
        const auto& int_variable_it = std::find_if(codegen_int_variables.begin(),
                                                   codegen_int_variables.end(),
        ...
        return (int_variable_it != codegen_int_variables.end() && (*int_variable_it).is_constant) || const_variable_it != info.constant_variables.end();
    }
    return is_constant;
}
